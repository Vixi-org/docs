...
<Warning>
Your plan limits how many courses you can have publicly listed at the same time. If you've reached that limit, switching another course to public surfaces an upgrade prompt instead. Your already-public courses stay live — you just can't add more until you upgrade or unlist one. See [Plans and premium](/premium) for details.
</Warning>
...
<CardGroup cols={2}>
  <Card title="Manage learners and enrollments" icon="users" href="/learners">
